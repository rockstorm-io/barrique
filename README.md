...
Barrique is a schema-based binary serialization format, enacting metadata, compression and streaming. The format was designed for locally storing large (>8 MiB) long-term memory objects.
...
Barrique serialization format specification declared [here](https://github.com/rockstorm-io/barrique/blob/main/SPEC.md)
